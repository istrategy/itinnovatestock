...
WHERE name  NOT like '1nvest%' \
 AND name NOT LIKE '%ETF%' \
 AND name NOT LIKE '%Ashburton%' \
 AND name NOT LIKE '%S&P%' \
 AND name NOT LIKE '%Coreshares%' \
 AND name NOT LIKE '%FNB ETN%' \
 AND name NOT LIKE '%ETN%' \
 \
 AND name NOT LIKE '%Satrix%' \
 \
 AND name NOT LIKE '%Investec Limited%' \
 AND name NOT LIKE '%NewFunds%' \
 AND name NOT LIKE '%Newfunds%' \
 AND name NOT LIKE '%NewGold%' \
 AND name NOT LIKE '%NewWave%' \
 AND name NOT LIKE '%PRF%' \
 AND name NOT LIKE '%Sygnia%' \
 \
 AND name NOT LIKE '%UBS%' \
 AND name NOT LIKE '%2YR%' \
 \
 AND name NOT LIKE '%AnBro%' \
 AND name NOT LIKE '%2YR%' \
 AND name NOT LIKE '%2YR%' \
 AND name NOT LIKE '%2YR%' \
order by name"
